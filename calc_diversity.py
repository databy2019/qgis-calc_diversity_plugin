...
from .calc_diversity_dialog import CalcDiversityDialog
from .diversity_function import dc_summarizePoly
import os.path
...
class CalcDiversity:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'CalcDiversity_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Calculator Diversity')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('CalcDiversity', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/calc_diversity/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Calculator Diversity'),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginVectorMenu(
                self.tr(u'&Calculator Diversity'),
                action)
    ...
    def run(self):
        ...
        if result:
            ...
            for poly in lyrPoly.getFeatures():
                ...
                QgsMessageLog.logMessage("Category : {}".format(sCategory), "Claculator Diversity", level = Qgis.Info)
                dct_summary = dc_summarizePoly(poly, lyrPoint, fldSpecies)

                QgsMessageLog.logMessage("Summary : {}".format(dct_summary), "Claculator Diversity", level = Qgis.Info)
